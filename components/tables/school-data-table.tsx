...
interface DataTableProps<TData, TValue> {
  ...
  export function SchoolDataTable<TData,TValue>({columns,data,empty_data_message,filters,paginations}:DataTableProps<TData, TValue>) {
  const store_modal = useSchoolStore()
