...
interface DataTableProps<TData, TValue> {
  ...
  export function SessionsDataTable<TData,TValue>({columns,data,empty_data_message,filters,paginations}:DataTableProps<TData, TValue>) { 
  const store_modal = useSchoolSessionStore(); 
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center gap-2 py-4">
        ...
        <Button type="button" className="ml-auto" onClick={store_modal.open}>Create new</Button>
