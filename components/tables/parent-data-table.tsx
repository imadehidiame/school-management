...
export function ParentDataTable<TData, TValue>({
  columns,
  data,
  empty_data_message,
  filters,
  ...
  const [visible_columns,set_visible_columns] = useState(['updatedAt','city','createdAt','phoneNumber','firstName']);
  ...
  useEffect(()=>{
    const handle_resize = ()=>{
      ...
      /*else if(window_size <= 500){
        ...
        set_filter_state(filtering(base_filter,['updatedAt','city','createdAt']));
        ...
        set_visible_columns(['firstName','phoneNumber','city','createdAt']);
        set_filter_type(0);
      }
        ...
        set_visible_columns(['firstName','phoneNumber','city','createdAt','updatedAt']);
        set_filter_type(0);
      }
      ...
      /*else if(window_size <= 700){
        ...
        set_filter_state(filtering(base_filter,[]));
        set_visible_columns(['firstName','phoneNumber','city','updatedAt','createdAt']);
        set_filter_type(0);
      }
    }
    handle_resize();
    ...
    <div className="w-full">
      <div className="w-full flex flex-col lg:flex-row gap-2 p-2">
        ...
        <Button type="button" className="sm:ml-auto text-sm" onClick={() => {
          useParentStore.setState({ is_update_modal_open: true });
        }}>
          Create new
        </Button>
      </div>
