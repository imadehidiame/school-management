...
export function RouteDataTable<TData, TValue>({
  columns,
  data,
  empty_data_message,
  filters,
  ...
  const store_modal = useTransportStore();
  ...
  const [visible_columns,set_visible_columns] = useState(['updatedAt','createdAt','vehicles','route']);
  ...
  useEffect(()=>{
    const handle_resize = ()=>{
      ...
      if(window_size < 640){
        ...
        set_filter_state(filtering(base_filter,['updatedAt','createdAt','vehicles']));
        set_visible_columns(['route']);
        set_filter_type(0);
      }
      /*else if(window_size <= 500){
        ...
        set_visible_columns(['route','vehicles']);
        set_filter_type(0);
      }
        ...
        set_visible_columns(['route','vehicles','createdAt']);
        set_filter_type(0);
      }
        ...
        set_visible_columns(['route','vehicles','createdAt','updatedAt']);
        set_filter_type(0);
      }
    ...
    <div className="w-full">
      <div className="w-full flex flex-col lg:flex-row gap-2 p-2">
        ...
        <Button type="button" className="sm:ml-auto text-sm" onClick={() => {
          useTransportStore.setState({ is_update_modal_open: true });
        }}>
          Create new
        </Button>
      </div>
